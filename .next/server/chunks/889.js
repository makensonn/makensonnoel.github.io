...
const ProjectItem = ({ title , backgroundImg , tech , projectUrl , sourceUrl  })=>{
    ...
    const containerStyle = "relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-[#c2c2c2] to-[#e4e4e4]";
    const imageStyle = "rounded-xl group-hover:opacity-10";
    const infoContainerStyle = "hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]";
    const titleStyle = "text-2xl text-white tracking-wider text-center";
    const techStyle = "pb-4 pt-2 text-white text-center";
    const buttonStyle = "text-center py-3 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer";
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProjectItems);
