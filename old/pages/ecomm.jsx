    ...
    <div className="w-full h-screen">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            This Ecommerce Website is being developed with JavaScript and
            TailwindCSS. It's coming soon, please visit other projects.
          </p>

          <a href="https://makenson.com/ecomm" target="_blank" rel="noreferrer">
