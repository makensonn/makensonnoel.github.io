      ...
      <div className="max-w-[1240px] mx-auto px-2 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <p>
            ...
            <br></br>
            <br></br>
            This is a an E-Commerce site for Thousand Men, LLC.
          </p>
          ...
          <p>
            ...
            <br></br>
            <br></br>
            This application is a recreation of the side scrolling mobile app
            game Flappy Bird using React-Native.
          </p>
          ...
          <p>
            ...
            <br></br>
            <br></br>
            This is a simple classic two-player board game played on a 3x3 grid
            using React.
          </p>
          ...
          <p>
            ...
            <br></br>
            <br></br>
            This is a interactive to-do-list that stores and deletes items on a
            list using React.
          </p>
