    ...
    <div id="about" className={containerStyle}>
      <div className={gridStyle}>
        <div className={textContainerStyle}>
          ...
          <p className="py-2"></p>
          <p className="py-2">
            Hello! 👋 I'm Makenson Noel, a highly motivated and detail-oriented
            entry-level Software Engineer with a passion for crafting robust and
            ...
            endeavors, I'm an active member of Haitians in Tech, demonstrating
            my commitment to fostering diversity and inclusion within the tech
            community. In my free time, I enjoy refurbishing and building
            personal gaming computers, combining my technical skills with a love
            for gaming. 🏆 Awards & Certifications: Awarded Best Accessibility
            App at PlutoHacks 2022. Certified in Deep Learning Onramp and
            Machine Learning Onramp by MathWorks (July 2020). 🎓 Education:
            Bachelor of Science in Computer Science from Florida Atlantic
            University, Boca Raton, FL (August 2021)
          </p>
          <br></br>
        </div>
